...
<head>
    ...
    <title>403 - Forbidden | BookSync</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="error-container">
        ...
        <p class="error-details"><?= htmlspecialchars($message ?? "You don't have permission to access this resource.") ?></p>
        
        <!-- Replaced image with Font Awesome lock icon -->
