...
<head>
    ...
    <title>404 - Page Not Found | BookSync</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="error-container">
        ...
        <p class="error-details"><?= htmlspecialchars($message ?? "The page you're looking for doesn't exist or has been moved.") ?></p>
        
        <!-- Replaced image with Font Awesome icon -->
        <div class="error-icon mb-4">
            <i class="fas fa-compass fa-5x text-warning"></i>
        </div>
